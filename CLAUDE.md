...
- `sidebarOrder` - Order of sidebar sections
...
**Critical:** pdf-document.tsx must stay in sync with CVPreview structure. When adding sections to editor, add to both components.
...
└── components/
    ...
    └── cv-editor/           # CV editing components
        ...
        ├── FloatingToolbar.tsx  # Rich text toolbar (bold, italic, etc.)
        ├── Experience.tsx       # Work history section
        ├── Education.tsx        # Education section
        ├── Courses.tsx          # Courses section (optional)
        ├── Certifications.tsx   # Certifications section (optional)
        ├── Awards.tsx           # Awards section (optional)
