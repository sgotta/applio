...
- `visibility` — Toggle visibility for photo, contact fields, and optional sections. When photo is hidden, name+title move to sidebar and the right-column header is removed
