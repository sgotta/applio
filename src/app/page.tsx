...
function Reveal({
  ...
  const [visible, setVisible] = useState(() => {
    // Immediately visible if user prefers reduced motion (avoids flash)
...
function SortableDragItem({
  ...
  return (
    <div
      ...
      className={`flex items-start gap-3 rounded-xl border bg-white dark:bg-white/5 px-4 py-3 transition-shadow duration-200 ${
        isDragging
    ...
    >
      <button
        className={`cursor-grab active:cursor-grabbing touch-none text-gray-300 dark:text-gray-600 hover:text-gray-500 dark:hover:text-gray-400 transition-colors mt-0.5 ${
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-gray-500 dark:text-gray-400 text-[0.7rem] leading-snug">
          {subtitle}
        </div>
        <div className="flex gap-1.5 mt-0.5 text-gray-400/80 dark:text-gray-500 text-[0.65rem] leading-snug">
...
function InteractiveDragMockup() {
  ...
  const [items, setItems] = useState([
    { id: "a", title: "Acme Corp", subtitle: "Senior Software Engineer", dates: "Mar 2021 — Present", desc: "Led migration to Next.js 14 and improved CI/CD pipelines." },
    { id: "b", title: "Tech Solutions Inc.", subtitle: "Frontend Developer", dates: "Jan 2019 — Feb 2021", desc: "Built reusable component library with React and TypeScript." },
    { id: "c", title: "Digital Agency", subtitle: "Junior Developer", dates: "Jun 2017 — Dec 2018", desc: "Developed responsive landing pages for 10+ clients." },
  ]);
      ...
      <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 overflow-hidden shadow-sm select-none">
        ...
        <div className="flex justify-center gap-2.5 p-3 border-t border-gray-100 dark:border-white/10">
          {COLOR_DEMO.map((scheme, i) => {
            const isLight = scheme.text !== "#ffffff";
            return (
              <button
                key={scheme.swatch}
                onClick={() => setActive(i)}
                className={`relative w-7 h-7 rounded-full transition-all duration-200 cursor-pointer ${
...
function LandingPageContent() {
  ...
  return (
    <div className="bg-white dark:bg-background text-gray-900 dark:text-white font-sans overflow-x-hidden">
      ...
      {/* ── Hero ───────────────────────────────────────────── */}
      <section className="relative min-h-svh flex flex-col items-center justify-center px-6 pt-24 sm:pt-32 md:pt-36 pb-12 sm:pb-16">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <Reveal delay={0.12}>
            <p className="text-base sm:text-base md:text-lg text-gray-500 dark:text-gray-400 text-center max-w-2xl mt-5 sm:mt-6 leading-relaxed">
              {t("hero.subtitle")}
            </p>
          </Reveal>

          <Reveal delay={0.24} className="mt-8 flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            <Link
              href="/editor"
            ...
            <a
              href="#features"
              className="inline-flex items-center justify-center gap-2 bg-gray-100 dark:bg-white/10 text-gray-700 dark:text-gray-300 font-medium rounded-full px-8 py-3 sm:py-3.5 text-base hover:bg-gray-200 dark:hover:bg-white/15 transition-colors"
            >
              {t("hero.ctaSecondary")}
            </a>
          </Reveal>
      ...
      <section className="py-24 md:py-32 px-6 bg-gray-50/60 dark:bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {(
              [
                { icon: FileDown, titleKey: "grid.pdfTitle" as const, descKey: "grid.pdfDesc" as const, color: "text-red-500 dark:text-red-400" },
                { icon: Globe2, titleKey: "grid.langTitle" as const, descKey: "grid.langDesc" as const, color: "text-blue-500 dark:text-blue-400" },
                { icon: Moon, titleKey: "grid.darkTitle" as const, descKey: "grid.darkDesc" as const, color: "text-violet-500 dark:text-violet-400" },
                { icon: Zap, titleKey: "grid.saveTitle" as const, descKey: "grid.saveDesc" as const, color: "text-amber-500 dark:text-amber-400" },
              ]
